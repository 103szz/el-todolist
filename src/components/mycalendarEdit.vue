...
const tasklist=ref([{id:"0",name:"待办事项1.....",content:"1.....2...3...",importance:"im1",createTime:"",competeTime:"2025-12-25",show: false,state:'competed'},
{id:"1",name:"待办事项2.....",content:"1.....2...3...",importance:"im2",createTime:"",competeTime:"2025-12-21",show: false,state:'no'},
{id:"2",name:"待办事项3.....",content:"1.....2...3...",importance:"im0",createTime:"",competeTime:"2025-12-20",show: false,state:'no'},
{id:"3",name:"待办事项4.....",content:"1.....2...3...",importance:"im1",createTime:"",competeTime:"2025-12-02",show: false,state:'no'}])

const myhasEvent = (dateString) => {
  const task= tasklist.value.find(user => user.competeTime === dateString)
  if(task)
    return true
  else
    return false
...
{
  const task= tasklist.value.find(user => user.competeTime === dateStr)
  if(task){
    if(task.state=='competed')
